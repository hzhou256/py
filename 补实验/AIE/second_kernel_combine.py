...
methods_name = ['CKSAAP', 'DPC', '188-bit', 'ASDC', 'AAC']
for it in range(n_kernels):
    name = methods_name[it]
    gram_train = np.loadtxt('D:/Study/Bioinformatics/补实验/AIE/kernels/second/K_train_'+name+'.csv', delimiter = ',')
    gram_test = np.loadtxt('D:/Study/Bioinformatics/补实验/AIE/kernels/second/K_test_'+name+'.csv', delimiter = ',')
