...
f3 = np.loadtxt('D:/Study/Bioinformatics/AFP/kernel_matrix/Antifp_DS2/KM_test_tanimoto/combine_tanimoto_test.csv', delimiter = ',')
f4 = np.loadtxt('D:/Study/Bioinformatics/AFP/feature_matrix/Antifp_DS2/test_label.csv', delimiter = ',')
