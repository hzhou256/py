...
for ds in range(2,3):
    ...
    for it in range(1):
        ...
        f1 = np.loadtxt('D:/Study/Bioinformatics/AFP/kernel_matrix_CKSAAP+DPC/' + name_ds + '/KM_train_tanimoto/combine_tanimoto_' + name + '_train.csv', delimiter = ',')
        f2 = np.loadtxt('D:/Study/Bioinformatics/AFP/feature_matrix/' + name_ds + '/train_label.csv', delimiter = ',')
        f3 = np.loadtxt('D:/Study/Bioinformatics/AFP/kernel_matrix_CKSAAP+DPC/' + name_ds + '/KM_test_tanimoto/combine_tanimoto_' + name + '_test.csv', delimiter = ',')
