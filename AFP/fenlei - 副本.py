...
#导入数据
f1 = np.loadtxt('D:/Study/Bioinformatics/AFP/feature_matrix/Antifp_Main/CKSAAP/train_CKSAAP.csv', delimiter = ',', skiprows = 1)
...
pd.DataFrame.to_csv(DF, 'D:/Study/Bioinformatics/AFP/feature_matrix/Antifp_Main/CKSAAP/train_CKSAAP_selected.csv')