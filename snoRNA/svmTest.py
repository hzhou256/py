...
dataset = ['CKSNAP', 'DNC', 'Kmer4', 'Kmer1234', 'NAC', 'RCKmer', 'TNC', 'AVG']
for i in range(7, 8):
    name = dataset[i]
    print(name)

    gram = np.loadtxt('D:/Study/Bioinformatics/snoRNA/tanimoto_kernel/KM_tanimoto_' + name + '_train.csv',
                      delimiter=',')
    y = np.loadtxt('D:/Study/Bioinformatics/王浩/data and code/data/feature/snoRNA/snoRNA_label.csv', delimiter=',',
                   skiprows=1)
