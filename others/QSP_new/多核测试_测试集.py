...
f3 = np.loadtxt('D:/Study/Bioinformatics/QSP_new/kernel_matrix_3/KM_test_tanimoto/combine_tanimoto_test.csv', delimiter = ',')
...
clf = svm.SVC(C = 4.094915062380419, kernel = 'precomputed', probability = False)
