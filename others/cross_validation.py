...
f1 = np.loadtxt('D:/study/Bioinformatics/QSP/300p_300n/ASDC/train_ASDC.csv', delimiter = ',', skiprows = 1)
f2 = np.loadtxt('D:/study/Bioinformatics/QSP/300p_300n/train_label.csv', delimiter = ',')
f3 = np.loadtxt('D:/study/Bioinformatics/QSP/300p_300n/ASDC/test_ASDC.csv', delimiter = ',', skiprows = 1)
