...
from mkl_SVM.hsic_kernel_weights_norm import hsic_kernel_weights_norm
from mkl_SVM.kernel_alignment import computer_kernels_weights
...
def skl_mk_svm(train_x,feature_id,train_y,test_x,test_y,c,gamma_list):
    ...
    acc = accuracy_score(test_y, y_pred, average="weighted")
    return y_pred, acc