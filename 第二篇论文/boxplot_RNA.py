...
wb = xlrd.open_workbook(filename='D:\\Study\\Bioinformatics\\王浩\\data and code\\matlab\\result\\RNA_result.xlsx')
...
plt.tight_layout()
plt.savefig("D:\\Study\\论文\\achemso_mlghknn\\figure\\boxplot\\RNA.png", dpi = 600)
plt.show()