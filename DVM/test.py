...
grid = GridSearchCV(Class_KDVM_v2.KDVM(kernel = 'rbf', n_neighbors = 10), parameters, n_jobs = -1, cv = cv, verbose = 1)
grid.fit(X, y)
gamma = grid.best_params_['gamma']

clf = Class_KDVM_v2.KDVM(kernel = 'rbf', gamma = gamma, n_neighbors = 10)
